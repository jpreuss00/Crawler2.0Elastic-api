package com.example.crawler.client.invoker;
...
import com.example.crawler.client.invoker.auth.Authentication;
import com.example.crawler.client.invoker.auth.HttpBasicAuth;
import com.example.crawler.client.invoker.auth.HttpBearerAuth;
import com.example.crawler.client.invoker.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  protected String basePath = "https://localhost.com:8080";
  ...
  public ApiClient() {
    ...
    setUserAgent("OpenAPI-Generator/1.1-SNAPSHOT/java");
