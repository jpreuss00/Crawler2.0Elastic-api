...
import api.client.invoker.auth.Authentication;
import api.client.invoker.auth.HttpBasicAuth;
import api.client.invoker.auth.HttpBearerAuth;
import api.client.invoker.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  protected String basePath = "https://localhost.com:9200";
